...
')
     ...
     */ 
        ...
        {
                        /** @var \Watson\Autologin\Autologin $instance */
         ...
         * @static 
         */ 
        public static function to($user, $path, $extra = [], $secure = null)
        {
                        /** @var \Watson\Autologin\Autologin $instance */
                        return $instance->to($user, $path, $extra, $secure);
        }
                    /**
         * Generate a link that will automatically login a user and then redirect
         ...
         * @static 
         */ 
        public static function route($user, $name, $parameters = [], $absolute = true, $route = null)
        {
                        /** @var \Watson\Autologin\Autologin $instance */
                        return $instance->route($user, $name, $parameters, $absolute, $route);
        }
                    /**
        ...
        {
                        /** @var \Watson\Autologin\Autologin $instance */
                        return $instance->validate($token);
        }
     ...
     */ 
         ...
         * 
         *
         * @param \Revolution\Amazon\ProductAdvertising\Contracts\DefaultApi $api
         ...
         * 
         *
         * @return \Revolution\Amazon\ProductAdvertising\Contracts\DefaultApi 
         * @static 
         */ 
...
namespace  { 
            ...
            class Autologin extends \Watson\Autologin\Facades\Autologin {}
