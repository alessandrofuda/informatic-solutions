...
{{-- search tutorial: sabe.io tutorial getting started with vue js 1 novembre 2017  --}}
			...
			<div id="products">
				...
				<div v-else class="">
					<div class="tot">
						Prodotti trovati: <span id="total_products">@{{ products.length }} SISTEMARE IN BASE AI FILTRATI DA SEARCH -</span>
					</div>
				    <div v-for="product in products" :id="product.asin" class="col-md-4">
				        ...
				        <div class="panel panel-primary">
							...
							<div v-if="product.created_at >= '{{ \Carbon\Carbon::now()->subDays(7) }}'">
								<div class="new-cont"></div>
								<div class="new">NUOVO</div>
							</div>
							<div class="panel-body">
								<div class="img-cont">
									<!--a href="{{-- route('product.view', $????->slug) --}}" :title="product.title"-->	
									    <img v-if="product.largeimageurl" :alt="'Immagine di '+product.title"
									    	 :title="product.title" 
									         class="img-responsive"
									         :src="product.largeimageurl" :height="product.largeimageheight" :width="product.largeimagewidth" />
									    <img v-else :alt="'Ancora non abbiamo nessuna immagine per '+product.title"
									    	 :title="'Immagine non disponibile per il prodotto '+product.title" 
									         class="img-responsive"
								...
								<div class="product-info">
									<b>Marca:</b> @{{ product.brand }} - <b>Colore:</b> <span v-if="product.color">@{{ product.color }}</span> <span v-else>Tutti</span>
