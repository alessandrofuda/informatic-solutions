...
<header>
    <div class="name">Informatic-solutions - @{{ title }}</div>
    <div class="actions">
        <a class="btn" href="#" ng-click="clearAll()">Pulisci tutto</a>
        <a class="btn" href="{{url(config('laravel-log-reader.admin_panel_path'))}}">Torna alla Dashboard</a>
    </div>
</header>
<section class="content">
    <div class="top_content">
        <div class="top_content_left">
            <div>
                <p class="selected_date" style="font-size: 14px;"><strong>
                        <span ng-show="response.success">Mostra i Logs: @{{data.date}}</span>
        ...
        <div class="top_content_right">
            <p class="dt_box">Seleziona Data: <select class="date_selector" ng-model="selectedDate"
    ...
    <script>
        ...
        myApp.controller("LogCtrl", function ($scope, $http) {
            ...
            $scope.clearAll = function () {
                if (confirm("Sei sicuro di voler cancellare tutti i logs?")) {
