...
<html lang="it-IT">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('css/child.css') }}">
    ...
    <div id="indice-jumb" class="jumbotron text-center">
      ...
      <div id="indice">
        <ul class="list-group">
          ...
          <li class="list-group-item">
            <a href="#detrazioni-fiscali-50-per-acquisto-installazione-videocitofoni">Le detrazioni fiscali sull'acquisto e installazione dei videocitofoni</a>
          </li>
          <li class="list-group-item">
            <a href="#iva-agevolata-acquisto-videocitofoni">L'Iva agevolata sull'acquisto dei videocitofoni</a>
          </li>
          <li class="list-group-item">
            <a href="#citofono-videocitofono-quale-scegliere">Citofono o Videocitofono, quale scegliere?</a>
          </li>
          <li class="list-group-item">
            <a href="#come-scegliere-videocitofono-adatto">Come scegliere il videocitofono più adatto</a>
          </li>
          <li class="list-group-item">
          ...
          <li class="list-group-item">
            <a href="#quali-marche-producono-impianti-videocitofonici">Quali sono le marche dei principali produttori</a>
          </li>
          <li class="list-group-item">
            <a href="#videocitofoni-wireless-senza-fili">I Videocitofoni Wireless</a>
          </li>
          <li class="list-group-item">
            <a href="#integrare-videocitofono-con-impianto-di-allarme-domestico">Integrare un videocitofono con un Impianto di Allarme Domestico</a>
          </li>
        </ul>
      </div>  
    </div><!--#indice-jumb-->
...
<p>Sui costi, diciamo subito una cosa: chi installa un videocitofono a casa può beneficiare della <strong>detrazione fiscale</strong> riservata alle ristrutturazioni edilizie: anche solo sostituire il vecchio citofono è infatti equiparabile ad una mini-ristrutturazione di casa che, come tale, gode dello sgravio fiscale Irpef sul 50% dei costi sostenuti.</p>
<p><strong>Come funziona la detrazioni fiscale Irpef 50%?</strong></p>
...
<li>L'immagine dello schermo deve essere stabile e nitida: controllare la qualità della comunicazione audio e video prima di cimentarsi nel montaggio.</li>
<li>Verificare il corretto funzionamento del tasto di apertura porta e di tutti gli altri tasti, sarebbe una bella scocciatura terminare l'installazione dell'apparecchio per poi accorgersi che un tasto non funziona.</li>
<li>Verificare il corretto funzionamento del monitor, dei microfoni e delle uscite audio.</li>
<li>Verificare che la "scatola esterna" sia comoda da utilizzare anche al buio, di notte e con condizioni atmosferche avverse (pioggia, neve,..). Controlare quindi il corretto funzionamento delle luci esterne ed il corretto isolamento della componente esterna.</li>
<li>Verificare (come è ovvio) le modalità di montaggio a parete.</li>
<li>Verificare la presenza della funzione automatica per il controllo dell'immagine.</li>
<li>La temperatura di funzionamneto della cassetta esterna deve essere in un <em>range</em> che va dai meno 30° ai più 50 gradi Centigradi.</li>
<li>La temperatura di funzionamento della stazione interna, invece, deve essere tra i meno 5 gradi ed i più 40.</li>
<li>La risoluzione dello schermo deve essere di almeno 350 righe TV.</li>
<li>Verificare la presenza ed il corretto funzionamento dell'indicatore di accensione.</li>
<li>Uno schermo comodo e funzionale deve essere uno schermo piatto di almeno 4 pollici.</li>
<li>La distanza massima della trasmissione dei dati deve essere di circa 200 metri (in altre parole, per usare termini più tecnici, l'impedenza della trasmissione dati deve essere di circa RVV5x 0.5mm2)</li>
<li>L'apparecchio, inoltre, deve poter funzionare con umidità relative che vanno dal 10 al 90 per cento.</li>
<li>Un'ultima verifica, infine, va fatta sul consumo elettrico, o meglio: sulla <em>potenza</em> elettrica. Un normale impianto deve avere un consumo massimo di 10 Watt.</li>
</ul>
...
<p>Con o senza led ad infrarossi per la visione notturna, con o senza retroilluminazione.</p>
<p>Ci sono poi video-citofoni con &#8220;cornetta&#8221; o senza cornetta (in vivavoce). Citofoni con pulsantiera in metallo o plastica, oppure col semplice schermo <em>touch screen.</em></p>
...
<p>Ecco i principali <strong>vantaggi dei video citofoni wireless</strong>.</p>
<ul>
<li>Possono essere installati ovunque: non avendo bisogno di cavi passacavi canaline, ecc&#8230;  possono comodamente essere utilizzati anche in edifici d&#8217;epoca senza alcun lavoro di muratura.</li>
<li>Possono essere installati molto più velocemente rispetto agli impianti cablati (cioè <em>&#8220;con fili&#8221;</em>).</li>
<li>Possono essere installati molto più economicamente, visto che non c&#8217;è bisogno del muratore nè di alcun lavoro di muratura.</li>
<li>Se è già presente un attacco elettrico, basta quello (uno per la parte esterna di &#8220;chiamata&#8221; ed uno per quella interna &#8220;di risposta&#8221;).</li>
<li>Se non c&#8217;è una presa elettrica esterna è possibile oggi addirittura realizzare un piccolo punto di allaccio elettrico con un pannello fotovoltaico ed una batteria.</li>
<li>Una volta che si sono installati i due blocchi principali (quello di chiamata e quello di risposta) è possibile aggiungere altri punti di risposta facilmente in tutte le stanza della casa e collegarlo anche al proprio smartphone.</li>
<li>L&#8217;impianto è facilmente scalabile e con ogni presa di casa si può creare una nuova postazione di risposta.</li>
<li>La tecnologia è facilmente integrabile con altre funzioni già presenti nella casa. E&#8217; possibile, ad esempio, aprendo il cancello, accendere una luce o una video-camera.</li>
</ul>
<p>&nbsp;</p>
...
<p>Se può risultare superfluo disquisire su  <em>&#8220;cosa serve un impianto di allarme&#8221;</em> non è per nulla scontato conoscere quali sono le misure di sicurezza più efficaci per preservare la propria casa dell&#8217;intrusione di indesiderati: non solo la tecnologia ci viene incontro, ma anche la &#8220;meccanica&#8221;.  Le misure di sicurezza <em>passive</em> sono le classiche porte blindate, le inferriate alle finestre, serrature di nuova generazione, ecc&#8230;</p>
<p>Quando si fa riferimento alla tecnologia, invece, si fa riferimento essenzialmente ai sistemi di videosorveglianza ed alla domotica come impianti di allarme efficaci <em>&#8220;anche senza serrature&#8221;</em>. Gli strumenti principali, in questo caso, sono telecamere, sensori, fotocellule, rilevatori di movimento, rilevatori di temperatura, raggi infrarossi.</p>
...
{{-- dd($tot)--}}
    ...
    @if (count($comments) > 0)
      <h4>
        <strong>{{ $tot }}</strong> comment{{ $tot === 1 ? 'o':'i' }} all'articolo <strong>{{ $comments->first()->post->title }}</strong>
      </h4>
    @endif
