...
<div id="comment-list" class="container-fluid" style="font-size: 11px;">
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                	...
                	<table id="dt-comments-list" class="table table-striped display" style="width: 100%;">
                		<thead>
                            <td><b>Id</b></td>
